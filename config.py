...
ADMINS = list(int(i.strip()) for i in os.environ.get("ADMINS").split("5313004751")) if os.environ.get("ADMINS") else []
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001689026148")) if os.environ.get("CHANNEL_ID") else []
...
USERNAME = os.environ.get("USERNAME", "Rk_botz")
